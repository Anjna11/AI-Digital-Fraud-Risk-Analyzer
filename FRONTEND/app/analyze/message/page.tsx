...
import { MessageForm } from "@/components/analysis-form/message-form";
  ...
  return (
    <div className="min-h-screen bg-bg">
      ...
      <div className="mx-auto max-w-3xl px-6 py-10">
        <h1 className="text-2xl font-semibold text-ink">Message analysis</h1>
        <p className="mt-1 text-ink-dim">
          Paste a suspicious SMS, email, or chat message before you reply or click anything in it.
        </p>
        ...
        <Card className="mt-6">
          <CardHeader>
            ...
            <CardDescription>Include as much of the original wording as possible.</CardDescription>
          </CardHeader>
          <CardContent>
            <MessageForm onAnalyze={handleAnalyze} loading={loading} />
          </CardContent>
        </Card>
        ...
        {loading && (
          <div className="relative mt-6 overflow-hidden rounded-lg border border-border bg-surface p-10 text-center">
            ...
            <p className="text-sm text-muted">Checking wording and structure for scam indicators…</p>
          </div>
        )}
